...
![Placeholder: CPU and Motherboard](path/to/hardware-cpu_mobo.png)
...
![Placeholder: Drive Bay Layout](path/to/drive-bay_layout.png)
...
![Placeholder: Unraid Dashboard Screenshot](path/to/unraid_dashboard.png)
...
![Placeholder: Home Assistant UI](path/to/home_assistant_ui.png)
