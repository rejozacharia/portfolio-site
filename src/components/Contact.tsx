    ...
    <section id="contact" className="py-20 bg-white">
      <div className="container mx-auto px-4 text-center max-w-2xl">
        ...
        <p className="text-lg text-gray-700 mb-8">
          Let&amp;apos;s connect and explore collaboration opportunities. Feel free to reach out via email or phone.
        </p>

        <div className="space-y-4 mb-8">
          {/* Dark text, blue hover for links */}
          <p className="text-gray-800">
            <a href="mailto:rejozacharia@gmail.com" className="hover:text-blue-600 transition duration-300">
              📧 rejozacharia@gmail.com
            </a>
          </p>
          <p className="text-gray-800">
            <a href="tel:+17074567356" className="hover:text-blue-600 transition duration-300">
              📞 (707) 456-7356
            </a>
          </p>
        </div>
        ...
        <div className="flex justify-center space-x-6">
          <a href="https://www.linkedin.com/in/rejozmathew/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-700 transition duration-300">
            {/* LinkedIn Icon */}
